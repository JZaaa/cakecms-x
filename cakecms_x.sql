...
MySQL - 5.7.19 : Database - cakecms_x
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cakecms_x` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `ad_menus`(`id`,`name`,`parent_id`,`level`,`icon`,`target`,`reload`,`sort`,`isshow`,`created`,`modified`) values (1,'系统管理',0,1,'fa-cogs','','',0,1,'2017-09-22 17:08:36','0000-00-00 00:00:00'),(3,'管理员组',1,2,'fa-caret-right','admin/roles/index','roles',0,1,'2017-09-22 17:08:41','0000-00-00 00:00:00'),(4,'用户管理',1,2,'fa-caret-right','admin/users/index','users',0,1,'2017-09-22 17:08:42','0000-00-00 00:00:00'),(5,'系统设置',1,2,'fa-caret-right','admin/options/index','options',0,1,'2017-09-22 17:08:44','0000-00-00 00:00:00'),(6,'菜单管理',1,2,'fa-caret-right','admin/menus/index','menus',0,1,'2017-09-22 17:08:51','0000-00-00 00:00:00'),(7,'信息管理',0,1,'fa-list-ul','','',1,1,'2017-09-22 17:08:53','0000-00-00 00:00:00'),(9,'栏目管理',7,2,'fa-caret-right','admin/arctypes/index','arctypes',0,1,'2017-09-22 17:08:56','0000-00-00 00:00:00'),(10,'文章管理',7,2,'fa-caret-right','admin/articles/index','articles',1,1,'2017-09-22 17:08:58','0000-00-00 00:00:00');
